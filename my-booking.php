...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="assets/images/car_logo.avif" alt="image">
      </div>
...
<li>
    <h4 style="color:red">Booking No #<?php echo htmlentities($result->BookingNumber);?></h4>
                ...
                <div class="vehicle_title">
                  ...
                  <div style="float: left"><p><b>Pick-up Location:</b> <?php echo htmlentities($result->pick_up_city);?> </p></div>

                  <div style="float: left"><p><b>Drop-off Location:</b> <?php echo htmlentities($result->drop_off_city);?> </p></div>
    ...
    <td><?php echo htmlentities($result->VehiclesTitle);?>, <?php echo htmlentities($result->BrandName);?></td>
     <td><?php echo htmlentities($result->FromDate);?></td>
      <td> <?php echo htmlentities($result->ToDate);?></td>
       ...
       <td><?php echo htmlentities($result->pick_up_city);?></td>
      <td> <?php echo htmlentities($result->drop_off_city);?></td>
...
<!-- end payment succssfully  -->
       
  </tr>
  <tr>
  <th colspan="6" style="text-align:center;"> Grand Total</th>
    <th><?php echo htmlentities($tds*$ppd);?></th>
    <th><button type="submit" name="btnpay" id="btnpay" class="btn" >Pay Now</button></th>
    <!-- <input type="submit" name="btnpay" id="btnpay" class="btn" value="Pay Now"> -->
