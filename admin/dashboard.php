								...
								<div class="row">
									<div class="col-md-3"s>
										<div class="panel panel-default">
											<div class="panel-body  text-light" style="background-color:#130f40">
...
?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body  text-light" style="background-color:#845EC2">
												<div class="stat-panel text-center">
												<?php 
...
?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body  text-light" style="background-color:#0081CF">
												<div class="stat-panel text-center">
<?php 
...
?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body  text-light" style="background-color:#D65DB1">
												<div class="stat-panel text-center">
<?php 
						...
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body  text-light" style="background-color:#fad390">
												<div class="stat-panel text-center">
<?php 
...
?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body  text-light" style="background-color:#ff793f">
												<div class="stat-panel text-center">
												<?php 
...
?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body  text-light" style="background-color:#54a0ff">
												<div class="stat-panel text-center">

										

												<?php 
$sql7 ="SELECT id from payment ";
...
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($query);?></div>
													<div class="stat-panel-title text-uppercase">Payment</div>
												</div>
											</div>
											<a href="payment.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body  text-light" style="background-color:#2C3A47">
												<div class="stat-panel text-center">
