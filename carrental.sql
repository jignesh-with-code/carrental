...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2024 at 10:17 AM
...
CREATE TABLE `payment` (
  ...
  `exp_month` varchar(250) NOT NULL,
  `exp_year` int(250) NOT NULL,
...
INSERT INTO `payment` (`id`, `zip_code`, `name`, `email`, `address`, `city`, `country`, `card_name`, `card_number`, `exp_month`, `exp_year`, `card_cvv`, `amount`) VALUES
(3, 5243, 'manish', 'manish@gmail.com', 'varacha', 'rajesthan', 'india', 'manishbhai', 1234, 'October', 2026, 1010, 1000),
(4, 123, 'manish', 'manish@gmail.com', 'varacha', 'rajesthan', 'india', 'manishbhai', 1234, 'November', 2026, 1234, 1000);
...
CREATE TABLE `tblbooking` (
  ...
  `pick_up_city` varchar(250) NOT NULL,
  `drop_off_city` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `tblbooking` (`id`, `BookingNumber`, `userEmail`, `VehicleId`, `FromDate`, `ToDate`, `message`, `Status`, `PostingDate`, `LastUpdationDate`, `pick_up_city`, `drop_off_city`) VALUES
...
(3, 140165072, 'raju@gmail.com', 5, '2024-02-07', '2024-03-14', 'ok', 1, '2024-03-21 09:55:20', '2024-03-21 09:58:37', '', ''),
(4, 146685305, 'raju@gmail.com', 2, '2024-03-14', '2024-03-20', 'thank you', 0, '2024-03-21 10:43:10', NULL, 'Surat', 'Valsad'),
(5, 638832710, 'a@gmail.com', 4, '2024-06-05', '2024-06-27', 'ayush home products from thank you ', 1, '2024-03-21 11:11:04', '2024-03-21 11:13:10', 'Rajkot', 'Bhuj'),
(6, 736440596, 'neel@gmail.com', 5, '2024-03-28', '2024-04-06', 'please book my car', 0, '2024-03-22 02:37:34', NULL, 'Surat', 'Ahmedabad'),
(7, 481327195, 'manish@gmail.com', 1, '2024-03-28', '2024-03-26', 'thank you', 0, '2024-03-22 05:49:01', NULL, 'Surat', 'Ahmedabad'),
(8, 642727993, 'raju@gmail.com', 8, '2024-03-25', '2024-03-30', 'hello', 0, '2024-03-22 09:01:14', NULL, 'Surat', 'Ahmedabad'),
(9, 612730722, 'raju@gmail.com', 6, '2024-03-24', '2024-03-30', 'done', 0, '2024-03-22 09:13:47', NULL, 'Surat', 'Gandhinagar');
...
(1, 'Varachha Main Road, Surat, Gujarat', 'carrental@gmail.com', '9724899277');
...
(11, 'FAQs', 'faqs', '																				<div>How can I book a car on your website?</div><div>Booking a car on our website is easy and convenient. Simply navigate to the \"Book Now\" section on our homepage or select your desired car from our fleet page. Once you\'ve chosen a car, select your preferred dates and times for pick-up and drop-off. Our system will show you the available options, including pricing and any additional services you may need, such as insurance or GPS navigation. Complete the booking process by providing your contact and payment information, and you\'re all set! You\'ll receive a confirmation email with all the details of your reservation.</div><div><br></div>\r\n										\r\n										');
...
(6, 'a@gmail.com', '2024-03-21 11:14:33');
...
(2, 'raju', 'raju@gmail.com', '35c773eec12a6f62cd97dad361cf3e63', '1234567890', '', 'fjfjfjfjmfjf', 'gujrat', 'india', '2024-03-21 09:54:06', '2024-03-22 04:07:14'),
(3, 'ayush home product', 'a@gmail.com', 'af9e7ec9eb9ebfa3373a6e049f5fa6f4', '1234567890', NULL, NULL, NULL, NULL, '2024-03-21 11:09:10', NULL),
(4, 'Neel', 'neel@gmail.com', 'fd786a107e05f72c0fb8c3540bca4d40', '1234567890', NULL, NULL, NULL, NULL, '2024-03-22 02:36:44', NULL),
(5, 'manish', 'manish@gmail.com', '84deda69dc38c4a39443e9b7a8230018', '1234567890', '', 'varacha', 'rajesthan', 'india', '2024-03-22 04:38:54', '2024-03-22 04:40:06');
