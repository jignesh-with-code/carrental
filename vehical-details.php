...
$sql="INSERT INTO  tblbooking(BookingNumber,userEmail,VehicleId,FromDate,ToDate,message,pick_up_city ,drop_off_city, Status) VALUES(:bookingno,:useremail,:vhid,:fromdate,:todate,:message,:pick_up_city , :drop_off_city ,  :status)";
...
$query->bindParam(':pick_up_city',$pick_up_city,PDO::PARAM_STR);
$query->bindParam(':drop_off_city',$drop_off_city,PDO::PARAM_STR);
...
<?php }} ?>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
         ...
         <select name="pick_up_city" id="city">
        ...
        <!-- end dropdown list code -->



        <!-- start dropdown list code -->

         <label for="city">DROP-OFF LOCATIION:</label>
         <select name="drop_off_city" id="city">
         <option value="Surat">Surat</option>
         <option value="Valsad">Valsad</option>
         <option value="Vadodara">Vadodara</option>
         <option value="Ahmedabad">Ahmedabad</option>
...
<script>
  ...
  // Set the min attribute of the date input to current date
